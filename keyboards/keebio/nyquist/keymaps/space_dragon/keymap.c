// Adapted from nyquist/keymaps/default by Danny Nguyen
 ...
 * |------+------+------+------+------+------| |------+------+------+------+------+------|
 * | Ctrl | Super| Alt  | Func |    Space    | |Lower |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------' '-----------------------------------------'
 */
[_QWERTY] = LAYOUT( \
...
[_FUNC] = LAYOUT( \
  ...
  _______, QWERTY,  KC_LANG1,KC_LANG4,_______, KC_LANG3,_______, _______, _______, _______, _______, _______, \
